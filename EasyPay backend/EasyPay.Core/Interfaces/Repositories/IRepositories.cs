...
public interface IEmployeeRepository : IGenericRepository<Employee>
{
    ...
    Task<(IEnumerable<Employee> Items, int Total)> GetPagedAsync(PaginationParams pagination, int? departmentId = null, int? designationId = null);
...
public interface IPayrollRepository : IGenericRepository<Payroll>
{
    ...
    Task<IEnumerable<Payroll>> GetForReportAsync(DateOnly periodStart, DateOnly periodEnd, string? status = null);
