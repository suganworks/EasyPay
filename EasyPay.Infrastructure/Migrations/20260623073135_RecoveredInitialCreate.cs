...
{
    /// <inheritdoc />
    public partial class RecoveredInitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9088), null, true, false, true, "CL", "Casual Leave", 0, 12, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9089) },
                    { 2, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9094), null, true, false, true, "SL", "Sick Leave", 0, 12, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9094) },
                    { 3, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9096), null, true, true, true, "PL", "Privilege Leave", 15, 15, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9096) },
                    { 4, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9098), null, true, false, false, "LOP", "Loss of Pay", 0, 0, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9098) },
                    { 5, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9099), null, true, true, true, "CO", "Compensatory Off", 5, 0, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(9100) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8794), "System Administrator", true, "Admin", new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8795) },
                    { 2, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8797), "HR Manager", true, "HRManager", new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8797) },
                    { 3, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8799), "Payroll Processor", true, "PayrollProcessor", new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8799) },
                    { 4, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8801), "Regular Employee", true, "Employee", new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8801) },
                    { 5, new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8803), "Team Manager / Supervisor", true, "Manager", new DateTime(2026, 6, 23, 7, 31, 32, 865, DateTimeKind.Utc).AddTicks(8804) }
                });
